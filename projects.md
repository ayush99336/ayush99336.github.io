...
<section class="panel quick-links stagger stagger-2">
  <h2>Featured</h2>
  <ul>
    <li><a href="https://github.com/ayush99336" target="_blank" rel="noopener noreferrer">GitHub profile</a> - code, experiments, and side work.</li>
    <li><a href="{{ '/blog/' | relative_url }}">Build logs</a> - engineering notes behind each project.</li>
  </ul>
</section>
